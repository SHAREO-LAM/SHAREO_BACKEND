...
export class Domain {
  ...
  @ApiPropertyOptional({ description: 'Numéro de la maison', type: String })
  ...
  @ApiPropertyOptional({ description: 'Capacité', type: String })
  ...
  @ApiPropertyOptional({ description: 'Date de mise à jour', type: String, format: 'date' })
  @Column('date', { name: 'datetime_update', nullable: true })
  datetimeUpdate: string | null;

  @ApiPropertyOptional({ description: 'ID de l’utilisateur créateur', type: String })
  @Column('bigint', { name: 'user_create_id', nullable: true })
  userCreateId: string | null;

  @ApiPropertyOptional({ description: 'ID de l’utilisateur mise à jour', type: String })
